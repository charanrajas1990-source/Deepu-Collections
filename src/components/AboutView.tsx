  ...
  return (
    <div className="py-16 px-4 md:px-8 max-w-5xl mx-auto">
      <div className="text-center mb-12">
        ...
        <h1 className="font-serif text-4xl font-bold text-[#2A0845] mt-2">About Deepu's Collection</h1>
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-purple-100 grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
        <div className="space-y-4">
          <h2 className="font-serif text-3xl font-bold text-[#2A0845]">Preserving Indian Handloom Craftsmanship</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-purple-50 shadow-sm text-center">
          <div className="w-12 h-12 bg-[#F7F2FA] rounded-xl flex items-center justify-center mx-auto mb-4 text-[#5C167D]">
            <Sparkles className="w-6 h-6" />
          </div>
          <h3 className="font-serif font-bold text-lg mb-2 text-[#2A0845]">100% Pure Silk</h3>
        ...
        <div className="bg-white p-6 rounded-2xl border border-purple-50 shadow-sm text-center">
          ...
          <h3 className="font-serif font-bold text-lg mb-2 text-[#2A0845]">Master Artisans</h3>
        ...
        <div className="bg-white p-6 rounded-2xl border border-purple-50 shadow-sm text-center">
          ...
          <h3 className="font-serif font-bold text-lg mb-2 text-[#2A0845]">Tailored For You</h3>
