...
export const FounderSection: React.FC = () => {
  return (
    <section className="py-8 md:py-14 bg-white border-y border-gray-100">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 bg-theme-cream rounded-3xl p-6 md:p-12 shadow-sm border border-gray-200">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl font-serif text-theme-maroon italic mb-6 leading-relaxed">
