      ...
      <div className="bg-theme-cream text-theme-maroon px-3 sm:px-4 md:px-8 py-3 md:py-2 flex items-center justify-between relative border-t-[3px] border-[#c9a24b] md:border-t-0 md:border-b-4 md:border-b-[#c9a24b] shadow-sm">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <span 
              className="font-serif font-black text-[0.85rem] min-[375px]:text-[0.95rem] sm:text-xl md:text-base leading-none tracking-wider uppercase bg-gradient-to-b from-[#FFEAA7] via-[#D4AF37] to-[#996515] bg-clip-text text-transparent drop-shadow-sm"
            >
              DEEPU'S COLLECTION
            </span>
